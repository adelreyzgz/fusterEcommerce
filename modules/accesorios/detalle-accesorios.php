...
<div id="page">
    <div id="main">
        ...
        <div id="content" class="column ocultBusca"  role="main">
            ...
            <h1 class="page__title title" id="page-title"><?=$nombreP?></h1>
                    ...
                    <div class="ficha-info">
                        <div class='ficha-general'>
                            ...
                            <div class="field field-name-field-descripcion-producto field-type-text field-label-above">
                                <div class="field-label fl"><span><?=${"lang_".$idioma}['descripcion'];?>:</span></div>
                                <div class="field-items">
                            ...
                            <?php if($caracteristicas){ ?>
                                <div class="field field-name-field-descripcion-producto field-type-text field-label-above">
                                    <div class="field-label fl"><span><?=${"lang_".$idioma}['datostecnicos'];?>:</span></div>
                                    <div class="field-items">
                        ...
                        <?php 
                        if($imgPlano){
                            $img = $imgPlano[0]['imagenFondo'];
                        ?>
                            <div style="text-align: center;margin-top: 22px;margin-bottom: 40px;">
                                <img src="assets/images/PC/<?=$img;?>" alt="<?='PC-' . $titlePP;?>" title="<?='PC-' . $titlePP;?>" style="width: 350px;">
                            </div>
                        <?php
                        }
                        ?>
                    ...
                    <div class="consulta-rss">
                        ...
                        <div class="consultar-formulario" style="display: none;">
                            ...
                            <div>
                                ...
                                <input placeholder="<?=${"lang_".$idioma}['nombre'];?>" type="text" id="edit-name" name="name" value="" size="60" maxlength="128" class="form-text required">
                                </div>
                                <div class="form-item form-type-textfield form-item-email">
                                <label for="edit-email"><?=${"lang_".$idioma}['email'];?> <span class="form-required" title="<?=${"lang_".$idioma}['campoObligatorio'];?>">*</span>
                                </label>
                                <input placeholder="<?=${"lang_".$idioma}['email'];?>" type="text" id="edit-email" name="email" value="" size="60" maxlength="128" class="form-text required">
                                </div>
                                <div class="form-item form-type-textfield form-item-phone">
                                <label for="edit-phone"><?=${"lang_".$idioma}['telefono'];?> <span class="form-required" title="<?=${"lang_".$idioma}['campoObligatorio'];?>">*</span>
                                </label>
                                <input placeholder="<?=${"lang_".$idioma}['telefono'];?>" type="text" id="edit-phone" name="phone" value="" size="60" maxlength="128" class="form-text required">
                                </div>
                                ...
                                <div class="form-item form-type-checkbox form-item-privacy-1">
                                    <input type="checkbox" id="edit-privacy-1" name="privacy[1]" value="1" class="form-checkbox">
                                ...
                                <input type="submit" class="form-submit btonsearchlateral buscarByProdMarcMod" style="width: 151px;font-size: 13px;" value="<?=${"lang_".$idioma}['enviarConsulta'];?>">
