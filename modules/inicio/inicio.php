<section class="slider">
    <div class="flexslider">
        ...
        ?>
        <li>
            <div class="views-field views-field-field-imagen-slider-home">
                <div class="field-content">
                    <img src="assets/images/slider-2_0.jpg" />
                </div>
            </div>
            <div class="views-field views-field-field-slider-home-texto-1">
                <div class="field-content"><p>534</p></div>
            </div>
            <div class="views-field views-field-field-slider-home-texto-2">
                <div class="field-content"><p><?=${"lang_".$idioma}['slider1']['title'];?></p></div>
            </div>
            <div class="views-field views-field-field-slider-home-boton">
                <div class="field-content">
                    <p><a href="<?=$idioma;?>/<?=${"lang_".$idioma}['puntodeventa']['url'];?>/"><?=${"lang_".$idioma}['slider1']['action'];?></a></p>
                </div>
            </div>
        </li>
        <?php } ?>
        <li>
            <div class="views-field views-field-field-imagen-slider-home">
                <div class="field-content">
                    <img src="assets/images/slider-1_0.jpg" />
                </div>
            </div>
            <div class="views-field views-field-field-slider-home-texto-1">
                <div class="field-content"><p><?=$cantid;?></p></div>
            </div>
            <div class="views-field views-field-field-slider-home-texto-2">
                <div class="field-content"><p><?=${"lang_".$idioma}['slider2']['title'];?></p></div>
            </div>
            <div class="views-field views-field-field-slider-home-boton">
                <div class="field-content">
                    <p><a href="<?=$idioma;?>/<?=${"lang_".$idioma}['productos']['url'];?>/"><?=${"lang_".$idioma}['slider2']['action'];?></a></p>
                </div>
            </div>
        </li>
        </ul>
...
<div id="intro-home">
    <div class="inner">
        <div class="one-four">
            <p>
                <img
                    class="fuster-icon-info"
                    alt="Info icon"
                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyAQMAAAAk8RryAAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAAA5JREFUeNpjYBgFgwkAAAGQAAHO016IAAAAAElFTkSuQmCC"
                    width="50"
                    height="50"
                />
                <?=${"lang_".$idioma}['repuestosfuster'];?>
            </p>
        </div>
        <div class="three-four">
            <?=${"lang_".$idioma}['infofuster'];?>
            
            <span id="expansible-read-more" class="expansible-read-more seguir-leyendo"><?=${"lang_".$idioma}['seguirleyendo'];?></span>
        </div>
    </div>
</div>
...
<div id="buscador-home">
    <div class="inner">
        <div class="one-four">
            <p>
                <img
                    class="fuster-icon-buscar"
                    alt="Search button"
                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyAQMAAAAk8RryAAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAAA5JREFUeNpjYBgFgwkAAAGQAAHO016IAAAAAElFTkSuQmCC"
                    width="50"
                    height="50"
                />
                <?=${"lang_".$idioma}['buscadoravanzado'];?>
            </p>
        </div>
        <div class="three-four">
            <div class="formulario-horizontal">
                <form action="<?=$base;?>es/busca-producto" method="get" id="fuster-buscador-hor-1" accept-charset="UTF-8">
                    <div class='contEFormHori'>

                        <div class="form-item form-type-textfield form-item-product" role="application">
                            <label class="label-es" style='' for="edit-product"><?=${"lang_".$idioma}['ndereferencia'];?> </label>
                            <select class="js-data-refoem"></select>
                        </div>

                        <button class="form-submit btnbuscar btnbuscar1 buscarByNoRef" type="button">
                ...
                <form action="<?=$base;?>es/busca-producto" method="get" id="fuster-buscador2" accept-charset="UTF-8">
                    <div class='contEFormHori cont222'>
                        <div class="form-item form-type-textfield form-item-product" role="application">
                        ...
                        <p class='msgErrMarc2' style=""> <?=${"lang_".$idioma}['seleccioneunamarca'];?> </p>
                        ...
                        <button class="form-submit btnbuscar btnbuscar2 buscarByProdMarcMod" style="" type="button">
                            <span class="sr-only"><?=${"lang_".$idioma}['buscar'];?></span>
                        </button>
...
<div id="page">
    <div id="main">
        <div id="seccion_lateral" class="lateral-home">
            <div class="block-video-corporativo">
                <h3><?=${"lang_".$idioma}['videocorporativo'];?></h3>
                    <iframe width="100%" height="160px" src="https://www.youtube.com/embed/4N9eOh5bpMA" title=" Recambios para tractores - Repuestos Fuster " frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p><?=${"lang_".$idioma}['conocerepuestosfuster'];?></p>
            </div>
            ...
            <div class="region region-seccion-lateral">
        ...
        <div id="content" class="column ocultBusca"  role="main">
            ...
            <ul class="wrapper" id='listadoCategorias'>
                <div class='loading'>
                    <div class="spinner-border"  style='border: .25em solid #e6e2dc;border-right-color: transparent;' role="status"></div>
                </div>
            </ul>
            <div class="slider-tractores">
                <h2 style='text-transform: uppercase;'><?=${"lang_".$idioma}['marca']['plural'];?></h2>
                <div style="display: flex;justify-content: center;">
                    <section style="width: 94%;" id='list-tractores' class="carruslell slider">
