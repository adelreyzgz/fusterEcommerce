...
var reporteT = 'Reporte de Pedidos';
...
var listadoT = "Listado de Pedidos";
var filtroT = "Filtro";

if(idioma == 'en'){
	detalleT = 'DETAILS';
	reporteT = 'Report of Orders';
		...
		if(response){
			...
			for (let index = 0; index < resultG.length; index++) {
				...
				<tr>\
					...
					<td>'+element.valor+'</td>\
					<td><a href="'+idioma+'/perfil/detallepedido/np-'+element.pedido+'/">'+detalleT+'</a></td>\
				</tr>\
				';
			}
